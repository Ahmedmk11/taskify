...
describe('User', () => {
    ...
    it('should sort tasks by title ascendingly', () => {
        const task2 = new Task('Task 2', 'Description', 'Work', 'High', new Date('2023-08-08'))
        const task3 = new Task('z Task 3', 'Description', 'Work', 'High', new Date('2023-08-08'))
    ...
    it('should sort tasks by dueDate ascendingly', () => {
        const task2 = new Task('Task 2', 'Description', 'Work', 'High', new Date('2023-08-09'))
        const task3 = new Task('Task 3', 'Description', 'Work', 'High', new Date('2023-08-10'))
        const tasks = [task2, task, task3]
    ...
    it('should sort tasks by priority ascendingly', () => { 
        const task2 = new Task('Task 2', 'Description', 'Work', 'Low', new Date('2023-08-08'))
        const task3 = new Task('Task 3', 'Description', 'Work', 'Medium', new Date('2023-08-08'))
        const tasks = [task2, task, task3]
    ...
    it('should show low priority tasks only', () => {
        user.createTask('Task 2', 'Description', 'Work', 'Low', new Date('2023-08-08'))
        user.createTask('Task 3', 'Description', 'Work', 'Low', new Date('2023-08-08'))
    ...
    it('should show medium priority tasks only', () => {
        user.createTask('Task 2', 'Description', 'Work', 'Medium', new Date('2023-08-08'))
        user.createTask('Task 3', 'Description', 'Work', 'Medium', new Date('2023-08-08'))
    ...
    it('should show high priority tasks only', () => {
        user.createTask('Task 2', 'Description', 'Work', 'High', new Date('2023-08-08'))
        user.createTask('Task 3', 'Description', 'Work', 'Low', new Date('2023-08-08'))
    ...
    it('should show tasks due on a certain day only', () => {
        user.createTask('Task 2', 'Description', 'Work', 'Low', new Date('2023-08-10'))
        user.createTask('Task 3', 'Description', 'Work', 'Low', new Date('2023-08-09'))
