                ...
                <div id="forgot-password-main">
                    <div id="forgot-password-main-content">
                        ...
                        >
                            ...
                            <Form.Item style={{marginBottom: '5px'}}>
                                ...
                                <div id='forgot-back-login-container'>
                                    <div id='forgot-back-login' onClick={() => {navigate('/home')}}>
                                        <LeftOutlined />
                                        <p>Back to Login</p>
                                    </div>
                                </div>
                        ...
                        : (<form id='forgot-password-sent'>
                            <h2 style={{ textAlign: 'center' }}>Reset your password</h2>
                            <p style={{ textAlign: 'center', fontSize: '14px' }}>We've sent you an email with a link to reset your password.</p>
                            <p style={{ textAlign: 'center', fontSize: '14px' }}>If you can't find the email, check your spam folder.</p>
                            <Button
                                type="primary"
                                htmlType="submit"
                                className="forgot-password-form-button"
